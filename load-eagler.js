    ...
    function initEngine() {
        ...
        base64ToUint8ArrayAsync(rawBase64, 131072, function(p) {
            ...
            let htmlPart1 = '<!DOCTYPE html>' +
                ...
                '</div>' +
                '<script>' +
                // 1. Completely mock window.Image & document.createElement('img') to avoid DOM CSP checks entirely
                ...
                '                that.naturalWidth = bitmap.width;' +
                '                that.naturalHeight = bitmap.height;' +
                '                that.complete = true;' +
                ...
                '};' +
                // 2. Patch Canvas drawImage to accept mock images
                ...
                '};' +
                // 3. Patch WebGL texImage2D / texSubImage2D to accept mock images
                ...
                '            if (last && last.__isMockImage && last._bitmap) {' +
                ...
                '    joinServer: ""' +
                '};' +
                // 4. Robust fetch mock for data: URLs
                ...
                '};' +
                // 5. XMLHttpRequest mock for data: URLs
